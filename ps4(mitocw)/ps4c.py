...
class SubMessage(object):
    ...
    def build_transpose_dict(self, vowels_permutation):
        ...
        # punc = list(" !@#$%^&*()-_+={}[]|\:;'<>?,./\"")
        # dic = {}
        # Upper_vowels_permutations = vowels_permutation.upper()
        ...
        #     dic[VOWELS_UPPER[i]] = Upper_vowels_permutations[i]
        # for pun in punc:
        #     dic[pun] = pun
        # return dict
...
class EncryptedSubMessage(SubMessage):
    ...
    def decrypt_message(self):
        ...
        # permutationsVowels = get_permutations('aeiou')
        # # iterate over each permutation to check
        # for combination in permutationVowels:
        #     test = []
        #     #Build a version of encrypted dictionary with new permutation
        #     dic = build_transpose_dict(permutationsVowels)
        #     decrypted = apply_transpose(dic)
        #     de_words = decrypted.split()
        #     #Test out the dict against the word with isWord
        ...
        return de_string[1:]        
            ...
            #Store the score of word that is true
            #If higher than highest score, replace
        #replace word
